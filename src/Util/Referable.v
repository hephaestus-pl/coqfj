...
Proof.
  induction xs, n; intros; try (inversion H; auto); simpl.
  * case eqb eqn:Beq; simpl in *.
    ** inversion H1.
       reflexivity.
    ** apply beq_id_false_neq in Beq.
       rewrite not_eq_beq_id_false in *; auto.
  * case eqb eqn:Heq; simpl in *.
    ** inversion H1;eauto.
    ** apply IHxs; auto.
Qed.
...
Section Findi.
  ...
  Proof.
    intros A R k a v l H H0; intro H1.
    inversion H1; crush.
  Qed.
