...
instance Print FD where
  prt i e = case e of
    FDecl id1 id2 -> prPrec i 0 (concatD [prt 0 id1, prt 0 id2])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ";"), prt 0 xs])
instance Print KD where
  prt i e = case e of
    KDecl id1 fieldss id2 assignmentss -> prPrec i 0 (concatD [prt 0 id1, doc (showString "("), prt 0 fieldss, doc (showString ")"), doc (showString "{"), doc (showString "super"), doc (showString "("), prt 0 id2, doc (showString ")"), doc (showString ";"), prt 0 assignmentss, doc (showString ";"), doc (showString "}")])
...
instance Print ID where
  ...
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print Assignments where
  prt i e = case e of
    Assignment id1 id2 -> prPrec i 0 (concatD [doc (showString "this"), doc (showString "."), prt 0 id1, doc (showString "="), prt 0 id2])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ";"), prt 0 xs])
instance Print MD where
  prt i e = case e of
    MethodDecl id1 id2 fieldss term -> prPrec i 0 (concatD [prt 0 id1, prt 0 id2, doc (showString "("), prt 0 fieldss, doc (showString ")"), doc (showString "{"), doc (showString "return"), prt 0 term, doc (showString ";"), doc (showString "}")])
  prtList _ [] = (concatD [])
